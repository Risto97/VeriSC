...
find_library(vcs_sc_uvm_lib uvm-systemc PATHS "$ENV{VCS_SYSTEMC_UVM}/*" NO_DEFAULT_PATH)
find_library(vcs_sc_uvm_env_lib SC_UVM_env PATHS "$ENV{VCS_SC_UVM_ENV_HOME}/*" NO_DEFAULT_PATH)
...
set(VCS_LD_LIBRARY_PATH "$ENV{VG_GNU_PACKAGE}/gcc-9.2.0_64-shared/lib64:$ENV{VG_GNU_PACKAGE}/gcc-9.2.0_64-shared/lib:$ENV{LD_LIBRARY_PATH}")
set(VCS_PATH_MOD "$ENV{VG_GNU_PACKAGE}/gcc-9.2.0_64-shared/bin/:$ENV{VG_GNU_PACKAGE}/binutils-2.33.1_64/bin/:$ENV{PATH}}")
